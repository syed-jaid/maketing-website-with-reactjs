      ...
      {!show ? (
        ...
        <div>
          ...
          <div className="flex items-center justify-center py-2">
            <button class="flex items-center justify-center py-2">
              <div class="shadow-2xl shadow-[#e73904] bg-[#e73904] max-w-xs sm:max-w-sm md:max-w-md lg:w-auto h-auto rounded-3xl p-3 text-white flex items-center justify-center hover:scale-105 transition-transform duration-300 ease-in-out">
                <div>
                  <h1 class="font-bold text-lg sm:text-xl md:text-2xl text-center">
                    BOOK A FREE CONSULTATION CALL
                    <br />
                    <span class="font-normal text-base sm:text-lg md:text-xl text-center">
