...
const Home = () => {
    return (
        <div>
            <div className='bg-black text-white font-bold text-[25px] text-center py-3'>🎉 GET 90% OFF TODAY FOR MARCH!
                <br />
            ...
            <div className=' shadow-lg border max-w-[819px] mx-auto text-center rounded-[15px] py-4 my-5'>
                ...
                <div className=' max-w-[650px] mx-auto  my-5 '>
                    <h1 className='text-[24px] font-bold text-[#e73904] border-b-2 pb-5 mb-5'>
                        Master ChatGPT while your competitors are still trying to figure it out!
                    </h1>
                    <div>
                        <h1 className='text-[24px]'>Total Value $3,997</h1>
                        <h1 className='line-through text-[24px]'>Retail Value $97</h1>
                    </div>

                    <h1 className='text-[48px] font-bold '>Get Everything For Just:</h1>
                    <h1 className='text-[36px] font-bold text-[#e73904] '>$27!</h1>

                    <div className='bg-[#e73904] py-2 rounded-[29px]'>
                        <h1 className=' text-[28px] font-bold text-white '>GET All Prompts + $1600 in Bonuses <br /> Today!</h1>
                        <h1 className=' text-[14px]  text-white'> No questions asked money back guarantee </h1>
                    </div>
                    <div className=' text-[14px] '>If you curious to know how to consistently get paid to get new clients, here's the secret...</div>
            ...
            <div className=' max-w-[650px] mx-auto mt-[60px] text-center'>
                <h1 className='text-[24px] text-[#e73904] font-bold'>HERE'S A SHOCKING TRUTH...</h1>
                <h1 className='text-[65px]'>😱 20 hours</h1>
            ...
            <div className='max-w-[1170px] mx-auto flex'>
                <img className='max-w-[555px] max-h-[1300px]' src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/3cfYZ62ndd3Fci44OcL9/media/65c36096805e4ba43839530a.png" alt="" />
                <img className='max-w-[555px] max-h-[1300px]' src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/3cfYZ62ndd3Fci44OcL9/media/65c36099805e4b8eb539530b.png" alt="" />
            </div>
            ...
            <div className='bg-[#f8f8f8] py-[40px] mt-[50px]'>
                <div className='max-w-[1160px] mx-auto leading-[45px]'>
                    <h1 className='text-center text-[40px] text-white bg-[#e73904]'><strong>Here's A Sneak Peek Of What You're Getting...👇</strong></h1>
